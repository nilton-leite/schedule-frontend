export const BASENAME = '/SGA'; // don't add '/' at end off BASENAME
export const BASE_URL = '/agenda';
export const BASE_TITLE = ' | Wambier';
...
export const ENDPOINT = {
  api: 'https://agenda.orlwambier.com.br:3333/api/',
  config: {
    headers: {
