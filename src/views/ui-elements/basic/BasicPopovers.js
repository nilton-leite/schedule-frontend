...
const BasicPopovers = () => {
  const popover = (
    <Popover id="popover-basic">
      ...
      <Popover.Content>
        Here's some <strong>amazing</strong> content. It's very engaging.
      </Popover.Content>
    </Popover>
  );
          ...
          <Card>
            ...
            <Card.Body>
              ...
              <OverlayTrigger trigger="click" placement="bottom" overlay={popover}>
                <Button className='ml-2' variant="primary">Bottom</Button>
              </OverlayTrigger>
              <OverlayTrigger trigger="click" placement="left" overlay={popover}>
                <Button className='ml-1' variant="success">Left</Button>
              </OverlayTrigger>
